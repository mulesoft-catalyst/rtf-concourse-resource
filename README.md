...
* **Sample Payload**
    ```
    {
        "source": {
            ...
            "client_id": "7866fbcc3b3 ... 1790f00477926dae32",
            "client_secret": "97774Db56dd ... C1Aa5481685658cb4C",
            "environment_name": "Development",
            "fabric_name": "dev-fabric",
            "group_id": "8cc90329 ... 5db10edc3257",
            "mule_env": "dev",
...
* **Sample Output**
    ...
    in - client_id: 7866fbcc3b3 ... 1790f00477926dae32
    in - client_secret: ****************
    post - endpoint: https://anypoint.mulesoft.com/accounts/api/v2/oauth2/token
    out - token: ffdf9602 ... a109a6b11677
    ...
    out - environment_id: c02e8cc1 ... 3551dd0e0f75

    _get_deployment_id
    in - arm_application_name: mule4-workerinfo-dev
    in - environment_id: c02e8cc1 ... 3551dd0e0f75
    in - group_id: 8cc90329 ... 5db10edc3257
    ...
    out - deployment_id: fbac10d4 ... 6d1b25994120

    _get_deployment_version
    in - environment_id: c02e8cc1 ... 3551dd0e0f75
    in - deployment_id: fbac10d4 ... 6d1b25994120
    in - group_id: 8cc90329 ... 5db10edc3257
...
* **Sample Output**
    ...
    - Using GROUP_ID: 8cc90329 ... 5db10edc3257
    ...
    in - client_secret: ****************
    post - endpoint: https://anypoint.mulesoft.com/accounts/api/v2/oauth2/token
    out - token: 11352bc4-f87d-4c57-b8f7-6f880225ae7b
...
* **Sample Payload**
    ```
    {
        ...
        "params": {
            ...
            "ENV_CLIENT_ID": "bdfea201b67c ... 393f65ab097975628",
            "ENV_CLIENT_SECRET": "a835230238d4 ... 3961A097ded787fEC",
...
* **Sample Output**
    ...
    - Using ENV_CLIENT_ID: bdfea201b67c ... 393f65ab097975628
    - Using ENV_CLIENT_SECRET: a835230238d4 ... 3961A097ded787fEC

    get_token_for_connected_app
    in - client_id: 7866fbcc3b3 ... 1790f00477926dae32
    in - client_secret: ****************
    post - endpoint: https://anypoint.mulesoft.com/accounts/api/v2/oauth2/token
    out - token: 11352bc4 ... 6f880225ae7b
    ...
    in - group_id: 8cc90329 ... 5db10edc3257
    get - endpoint: https://anypoint.mulesoft.com/hybrid/api/v2/organizations/8cc90329 ... 5db10edc3257/environments/c02e8cc1 ... 3551dd0e0f75/deployments
    out - deployment_id: e603a524 ... f53c286ab090
    ...
    in - num_replicas: 1
    in - env_client_id: bdfea201b67c ... 393f65ab097975628
    in - env_client_secret: ****************
